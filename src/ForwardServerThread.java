...
public class ForwardServerThread extends Thread implements ForwardServerClientThread
{
     ...
     */
    public ForwardServerThread(ServerSocket listensocket, String serverhost, int serverport, byte[] key, byte[] iv) throws IOException
    {
        mListenSocket = listensocket;
        mServerPort = serverport;
        mServerHost = serverhost;
        this.sessionEncrypter = new SessionEncrypter(key, iv);
        this.sessionDecrypter = new SessionDecrypter(key, iv);
    }
    ...
    public void run()
    {
        try {
            ...
            InputStream clientIn = this.sessionDecrypter.openCipherInputStream(mClientSocket.getInputStream());
            OutputStream clientOut = this.sessionEncrypter.openCipherOutputStream(mClientSocket.getOutputStream());
